...
const deleteCommentBlog = (blogId, commentId, userId) => new Promise((resolve, reject) => {
    blogModel.findOneAndUpdate(
        {
            _id: blogId,
            comments: {
...
export { saveBlog, deleteBlog, likeBlog, unLikeBlog, commentBlog, deleteCommentBlog };